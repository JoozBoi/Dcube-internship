  ...
  const handleLoginSubmit = (e) => {
    ...
    if (activeTab === 'admin') {
      if (adminKey === '99238382') {
        const adminUser = users.find(u => u.username === 'admin') || { username: 'admin', email: 'admin@vazhikal.io', password: '99238382', role: 'admin' };
        onAuthenticate('admin', adminUser);
      } else {
